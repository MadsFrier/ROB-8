...
class NavBotV2GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("NavBot V2 GUI - Model: GPT-3.5 Turbo 0125")
    ...
    def send_message(self, event=None):
        ...
        if user_message.strip():
            ...
            if test == True:
                f = open("Assistant_3_5_Single_Obj_Test.txt", "a")
    ...
    def get_response(self, user_message):
        ...
        while my_run.status in ["queued", "in_progress"]:
            ...
            if keep_retrieving_run.status == "completed":
                ...
                if test == True:
                    f = open("Assistant_3_5_Single_Obj_Test.txt", "a")
                    f.write('Model Response: ' +assistant_message)
                    f.close()
                self.loading = False 
                time.sleep(0.5)
